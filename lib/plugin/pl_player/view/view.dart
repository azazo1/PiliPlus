...
class _PLVideoPlayerState extends State<PLVideoPlayer>
  ...
  GestureType? _resolveVerticalGestureType(double tapPosition) {
    ...
    if (tapPosition < sectionWidth) {
      ...
      return PlatformUtils.isDesktop ? GestureType.right : GestureType.left;
    }
  ...
  void _onPanUpdate(ScaleUpdateDetails details) {
    if (_gestureType == null) {
      final initialFocalPoint = _initialFocalPoint;
      if (initialFocalPoint == null) {
        return;
      }
      final cumulativeDelta = details.localFocalPoint - initialFocalPoint;
              ...
              () {
                ...
                return Offstage(
                  ...
                  child: Stack(
                    ...
                    children: [
                      Obx(() {
                        final isSeeking = plPlayerController.isSeeking.value;
                        return ProgressBar(
                          ...
                          barHeight: 3.5,
                          thumbRadius: isSeeking ? 6 : 2.5,
                          thumbGlowRadius: isSeeking ? 18 : 6,
                          highlightThumb: isSeeking,
                        );
                      }),
