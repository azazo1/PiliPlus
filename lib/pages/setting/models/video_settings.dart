...
List<SettingsModel> get videoSettings => [
  ...
  NormalModel(
    ...
    getSubtitle: () =>
        '当前: ${Pref.bufferSize}MB. 同时为前向和后向缓冲区大小. 对于直播流, 无后向缓冲大小, 全部转给前向(此选项即 mpv 的 --demuxer-max-bytes, --demuxer-max-back-bytes)',
  ...
  NormalModel(
    ...
    getSubtitle: () =>
        '当前: ${Pref.bufferSec}s. 实际缓冲为二者最小值. 对于直播流, 该选项无效(此选项即 mpv 的 --cache-secs)',
